<?php
	...
	//local
	$gn1 = "localhost";
	$gn2 = "onesource"; //username
	$gn3 = "jz2JQNaC";
	$gn4 = "onesource";
	//
	//pfmdev
	//$gn1 = strrev(base64_decode("dHNvaGxhY29s")); 
	//$gn2 = strrev(base64_decode("a3Nmb2tpaGM="));
	//$gn3 = strrev(base64_decode("cmVzdXdlbg=="));
	//$gn4 = strrev(base64_decode("MTBkNjNuaWY="));
	
	define("EZSQL_DB_HOST", $gn1);		// <-- mysql server host
	define("EZSQL_DB_USER", $gn2);		// <-- mysql db user
	define("EZSQL_DB_PASSWORD", $gn3);	// <-- mysql db password
	define("EZSQL_DB_NAME", $gn4);		// <-- mysql db pname
