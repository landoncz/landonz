...
// Licensed exclusively to One Source Payments, LLC.
// Include files
...
$title   = "One Source Payments - Retail";
$header  = file_get_contents( "html/header_retail.html" );
$content = file_get_contents( "html/retail.html"         );
