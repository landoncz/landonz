...
$title   = "One Source Payments - Associations and Partners";
$header  = file_get_contents( "html/header_associations.html"  );
$content = file_get_contents( "html/associations.html" );
